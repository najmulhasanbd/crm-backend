                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <div class="form-floating mb-3">
                                                                    <input class="form-control" id="lead_id"
                                                                        name="lead_id" placeholder="lead_id" required
                                                                        type="text">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <div class="form-floating mb-3">
                                                                    <input class="form-control" id="passport"
                                                                        name="passport" placeholder="contact" required
                                                                        type="text">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                <div class="form-floating mb-3">
                                                                    <input class="form-control" id="follow_up"
                                                                        name="follow_up" placeholder="follow_up" required
                                                                        type="date">
...
// If it's already an array
                                                ...
                                                <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
                                                    ...
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-lg">
                                                        <form action="{{ route('lead.update', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="submit"
                                                                            class="btn btn-primary">Update Lead</button>
