        ...
        <div class="container-fluid">
            ...
            <div class="row m-1">
                <div class="col-12 col-md-6">
                    <h4 class="main-title">Admin List </h4>
                ...
                <div class="col-12 col-md-6 d-flex justify-content-end">
                    <div class="list-table-header d-flex justify-content-sm-between mb-3">
                        ...
                        <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="exampleModal"
                            tabindex="-1">
                            <form id="add_employee_form" method="POST" action="{{ route('user.store') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="photo" name="photo" required
                                                            type="file">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="salary" name="salary"
                                                            placeholder="contact" required type="number">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="mobile" name="mobile"
                                                            placeholder="contact" required type="text" maxlength="11">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control basic-date" name="birth_date" required
                                                            id="birth_date" type="date" placeholder="YYYY-MM-DD">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control basic-date" id="join_date" required
                                                            name="join_date" type="date" placeholder="YYYY-MM-DD">
